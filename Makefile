...
ttbb_delphes:
	python code/data_prep.py --input /pnfs/psi.ch/cms/trivcat/store/user/jpata/tth/delphes/GC48647908c2c2/Delphes_ttbb_inclusive --output ${OUTDIR}/ttbb_delphes.h5

# from https://github.com/betchart/analytic-nu (arXiv:1305.1878)
# adapted to use sciki-hep lorentz vectors instead of ROOT
import numpy as np
## import ROOT as r
import math
...
class nuSolutionSet(object):
    ...
    def __init__(self, b, mu,  # Lorentz Vectors
        ...
        c = math.cos( b.vector.angle(mu.vector) )
        s = math.sqrt(1-c**2)
...
class doubleNeutrinoSolutions(object):
    ...
    def __init__(self, bb, mm,  # 4-vectors
                 met,              # ETmiss
                 mW2=mW**2, mT2=mT**2):
        b, b_ = bb
        mu, mu_ = mm
    ...
    def nunu_s(self):
        ...
        return np.array([[K.dot(s), K_.dot(s_)]
